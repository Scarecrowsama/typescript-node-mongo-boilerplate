[![Build Status](https://travis-ci.com/Scarecrowsama/typescript-node-mongo-boilerplate.svg?branch=master)](https://travis-ci.com/Scarecrowsama/typescript-node-mongo-boilerplate)
